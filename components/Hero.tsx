...
function Hero() {
    return (
        <section className="flex items-center flex-1 pt-36 pb-36 ">
            <div className="flex flex-col w-full ">
                <h1 className="text-5xl font-extrabold text-center lg:text-9xl 2xl:text-8xl">
                ...
                <p className="mt-8 text-center text-gray-700 dark:text-white text-md md:text-xl">Notify me when Beta is launched :)</p>
            </div>
        </section>
